...
public:
	...
	void SetTemp2Amplitude(vfloat TempAmplitudeIn) {Temp2Amplitude = TempAmplitudeIn;} //!< Amplitude of second temperature variable  @param[in] TempAmplitudeIn Desired temperature variation amplitude in degrees celcius.
	vfloat GetTemp2Amplitude(void) {return Temp2Amplitude;} //!< Return periodic temperature variation amplitude.
...
private:
	...
	vfloat TempBase, TempAmplitude, Temp2Amplitude, TempPeriod; //degress celcius
