...
corner_topright = [253 164];   %generated by hand or from green points
...
figure(2)
height = hypot(contour_top(1,1)-contour_bottom(end,1),contour_top(1,2)-contour_bottom(end,2));
finger.origin=[0 0 0]; finger.angle=0; finger.up=0; finger.len = len; finger.height = height; finger.width = height;
